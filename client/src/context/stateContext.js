...
export const StateContextProvider = ({ children }) => {
  const { contract } = useContract('0xac2Ca5d89ad302B25D19397B54080F53aA74afCe');

  const {contract : userContract} = useContract('0x543358cbE2c7620181f3FDD0f16503B1dcCE57e2');
